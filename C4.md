...
A Unity-specific attribute which informs the editor that this script will not work unlessthere is a Rigidbody2D and an AudioSource on the GameObject.
...
A Unity-specific attribute which informs the editor that this script will not work unlessthere is a JumpMovement component on the GameObject.
