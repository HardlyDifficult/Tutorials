...
Create a project, import assets, and set some configurations.
 ...
 - 1.1) [Start a project](#start-a-project)
 - 1.2) [Import assets](#import-assets)
 - 1.3) [Configure sprites](#configure-sprites)
 - 1.4) [Disable anti aliasing](#disable-anti-aliasing)
 - 1.5) [Select an aspect ratio](#select-an-aspect-ratio)
 - 1.6) [Configure camera](#configure-camera)
 - 1.7) [Add an auto save script](#add-an-auto-save-script)
 - 1.8) [To review](#to-review)
