...
<hr></details><br>
<details open><summary>The code explained</summary>
...
The name of this class is irrelevant, as we will never access it from another class.  The only entry point is via InitializeOnLoad.
