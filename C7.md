...
[YouTube]() | [Source before](https://github.com/hardlydifficult/2DUnityTutorial/archive/GameControllerClearLevel.zip) | [Source after]()
...
**Create AwardPointsOnJumpOver**:
 ...
 - Create script Code/Effects/**AwardPointsOnJumpOver**:
...
<br>**Create HoldRotation**:
 ...
 - Create script Code/Movement/**HoldRotation**:
...
<br>**Create Layer**:
 ...
 - Create a new Layer for "Points"
   - In the Collision Matrix: disable all collisions with Points except for Points / Player collisions.
